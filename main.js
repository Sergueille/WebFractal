...
function Render() {
    ...
    */
    ...
    let renderCamPos = new vec2(Math.round(cameraPos.x / cameraWidth * canvasSize.x) * cameraWidth / canvasSize.x, Math.round(cameraPos.y / cameraSize * canvasSize.y) * cameraSize / canvasSize.y);
    if (!lastCamPos)
        lastCamPos = cameraPos;
    let renderCamLastPos = new vec2(Math.round(lastCamPos.x / cameraWidth * canvasSize.x) * cameraWidth / canvasSize.x, Math.round(lastCamPos.y / cameraSize * canvasSize.y) * cameraSize / canvasSize.y);
    // Draw main quad
